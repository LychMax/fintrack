...
function Modal({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl p-5 sm:p-6 relative"
  ...
  return (
    <div className="space-y-5 lg:space-y-8">
      ...
      {isLoading ? (
        ...
        >
          <Tag className="w-14 h-14 lg:w-16 lg:h-16 text-muted-foreground mx-auto mb-4 opacity-40" />
          <h3 className="text-lg lg:text-xl font-semibold text-foreground mb-2">
            Нет категорий
          </h3>
          <p className="text-muted-foreground text-sm mb-6">
            Добавьте первую категорию для организации транзакций
          </p>
          <button
            onClick={openCreate}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-4">
          {categories.map((cat) => {
            ...
            return (
              <div
                key={cat.id}
                className="rounded-2xl p-4 lg:p-5 flex items-center gap-3 lg:gap-4 group transition-all hover:border-primary/30"
                style={{
              ...
              >
                <div
                  className="w-10 h-10 lg:w-11 lg:h-11 rounded-xl flex items-center justify-center text-lg font-bold flex-shrink-0 transition-transform group-hover:scale-110"
                  style={{
                    background: `${color}25`,
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-foreground truncate text-sm lg:text-base">
                    {cat.name}
                  </p>
                </div>
      ...
      >
        ...
        <p className="text-muted-foreground mb-6">
          Вместе с категорией будут удалены все связанные транзакции.
        </p>
